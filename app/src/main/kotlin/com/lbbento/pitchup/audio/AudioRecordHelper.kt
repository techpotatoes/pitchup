    ...
    companion object {
        ...
        fun getSampleRate(): Int {
            ...
            for (rate in SAMPLE_RATES) {
                val bufferSize = getMinBufferSize(rate, CHANNEL_IN_DEFAULT, ENCODING_PCM_16BIT)
                if (bufferSize > 0) {
                    sampleRate = rate
                }
            }
        ...
        fun getReadSize(): Int {
            val minBufferSize = getMinBufferSize(getSampleRate(), CHANNEL_IN_DEFAULT, ENCODING_PCM_16BIT)
